      ...
      <div class="row row-cols-1 row-cols-sm-2 ms-4 ms-sm-0" style="margin-bottom: 50px;">
          <div class="card col-4 me-5 mb-5" style="width: 26rem;border-color: black;border-style: solid; border-radius: 15px; border-width: 1px; background-color: rgb(253, 247, 239);">
            <div class="card-body">
             ...
             <p class="py-2" style="margin-left: 20px; font-size: 17px;"><span class="fw-bold locationcheck1"><div id="pickupBranch"></div></span><br><a class="showmap1" href="https://goo.gl/maps/D1bYPYAGmVsz7H3AA">按此顯示地圖</a></p>
          ...
          <div class="card col-4 me-5 mb-5" style="width: 26rem;border-color: black;border-style: solid; border-radius: 15px; border-width: 1px; background-color: rgb(253, 247, 239);">
            <div class="card-body">
             ...
             <p class="py-2" style="margin-left: 20px; font-size: 17px;"><span class="fw-bold locationcheck2"><div id="returnBranch"></div></span><br><a class="showmap2" href="https://goo.gl/maps/hMskNwCdmrrGaPy19">按此顯示地圖</a></p>
